...
ctld.numberOfTroops = 13 -- default number of troops to load on a transport heli or C-130
...
ctld.loadableGroups = {
  {name = "Mi-8 Assault Group", inf = 8, mg = 3, at = 2 },
  {name = "Mi-8 SpecOps Group", inf = 3, at = 2, aa = 1  },
}
